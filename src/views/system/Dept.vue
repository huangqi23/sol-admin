  ...
  <!--<div>-->
    ...
    <!--<el-form :inline="true" :model="formInline" class="user-search">-->
      ...
      <!--<el-form-item>-->
        ...
        <!--<el-button size="small" type="primary" icon="el-icon-plus" @click="handleEdit()" v-has="'dept:test'">测试</el-button>-->
      <!--</el-form-item>-->
    <!--</el-form>-->
    <!--&lt;!&ndash;列表&ndash;&gt;-->
    <!--<el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">-->
      ...
      <!--</el-table-column>-->
      <!--<el-table-column sortable prop="id" label="部门代码" width="300">-->
      <!--</el-table-column>-->
...
<!--<script>-->
<!--import {deptList, deptSave, deptDelete } from '../../utils/actions.js';-->
